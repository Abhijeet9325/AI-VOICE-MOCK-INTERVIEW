          ...
          {feedbacks.map((feed) => (
            ...
            >
              <AccordionTrigger
                ...
                className={cn(
                  "px-5 py-3 flex items-center justify-between text-base rounded-t-lg transition-colors text-gray-800 dark:text-gray-200",
                  activeFeed === feed.id
                    ? "bg-gradient-to-r from-purple-50 to-blue-50"
                    : ""
                )}
              >
                <span className="font-medium tracking-tight">{feed.question}</span>
              </AccordionTrigger>
              ...
              <AccordionContent className="px-5 py-6 bg-white rounded-b-lg space-y-5 shadow-inner">
                ...
                <Card className="border-none space-y-3 p-4 bg-green-50 rounded-lg shadow-md">
                  ...
                  <CardDescription className="font-medium text-base text-gray-800 dark:text-gray-200">
                    {feed.correct_ans}
                  </CardDescription>
                </Card>
