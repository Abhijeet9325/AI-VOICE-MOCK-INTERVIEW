...
export const MockLoadPage = () => {
  ...
  return (
    <div className="flex flex-col w-full gap-8 py-5">
      ...
      {interview && <InterviewPin interview={interview} />}
      ...
      <div className="flex items-center justify-center w-full h-full">
        <div className="w-full h-[400px] md:w-96 flex flex-col items-center justify-center border p-4 bg-orange-50 rounded-md">
          {isWebCamEnabled ? (
            <WebCam
